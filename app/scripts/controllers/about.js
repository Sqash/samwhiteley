  ...
  .controller('AboutCtrl', function ($scope) {
    ...
    var personal = {
      ...
      content: [
        ...
        'Want to see what kinds of things I hack up in my spare time? Want ' +
        'me to code up something for you? Check out \'Projects\'!',
    ...
    var compSci = {
      ...
      content: [
        'I like it all!',
        'Seriously though, everything from the newest of NASA\'s launch tests ' +
        'to the websites I hack up for friends to the coolest applications of ' +
        ...
        'Insofar as my education has come, I\'m much better at the first ' +
        'of those two things.',
        'My personal interests lie in web-based solutions to world problems ' +
        '(big and small alike) and in big data computation. I\'m still ' +
        'working on my expertise in the second.',
        'Most of my recent projects have been geared towards providing tools ' +
        'for people I know who don\'t code. It\'s continuing to be a really ' +
        'rewarding experience; where I can learn, test new ideas and ' +
    ...
    var volunteering = {
      ...
      content: [
        ...
        'check it out and likely even play it at Carleton University campus',
